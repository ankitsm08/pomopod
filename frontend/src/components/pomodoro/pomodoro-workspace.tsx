...
} from "@/components/pomodoro/pomodoro-notifications";

import { cn } from "@/lib/utils";

type SessionId = PomodoroSessionId;
                            ...
                            <div>
                              <div className="flex items-center justify-between gap-4">
                                <div>
                                  ...
                                  <p className="mt-1 text-sm text-muted-foreground">
                                    Choose how many focus sessions happen before
                                    a long break.
                                  </p>
                                </div>
                              ...
                              <Slider
                                ...
                                step={0.001}
                                value={[
                                  Math.cbrt(timerSettings.longBreakAfter),
                                ]}
                                onValueChange={([value]) => {
                                  handleTimerSettingChange(
                                    "longBreakAfter",
      ...
      <Toaster
        ...
        toastOptions={{
          ...
          classNames: {
            ...
            icon: "shrink-0",
            title:
              "ml-1 text-xs leading-none font-medium tracking-[0.16em] uppercase text-muted-foreground",
          },
        }}
      />
    </>
